    ...
    return (
        <div className="grid dashboard">
            ...
            <div className="col-12 p-md-12 lg:col-6">
                <div className="card height-100">
                    <DataTable value={products} paginator rows={8} className="p-datatable-products" selection={selectedProduct} onSelectionChange={(e) => setSelectedProduct(e.value)}>
                    ...
                    <div className="widget-chat">
                        <ul ref={chatcontainer}>
                            {chatMessages.map((chatMessage, i) => {
                                ...
                                return (
                                    <li key={i} className={classNames('flex align-items-start', { from: chatMessage.from, 'own justify-content-end': !chatMessage.from, 'mb-3': !last, 'mb-1': last })}>
                                        ...
                                        <div className={classNames('messages flex flex-column', { 'align-items-start': chatMessage.from, 'align-items-end': !chatMessage.from })}>
                                            {chatMessage.messages.map((message, i) => {
                                                const first = i === 0;
                                                return (
                                                    <span key={i} className={classNames('message', { 'cyan-bgcolor': chatMessage.from, 'pink-bgcolor': !chatMessage.from, 'mt-1': !first })}>
                                                        {message}
                                                    </span>
                                                );
                                            })}
